...
local hreg = mc.mcRegGetHandle(inst, "iRegs0/2025/PlateThickness")
local PlateOffset = mc.mcRegGetValue(hreg)
hreg = mc.mcRegGetHandle(inst, "iRegs0/2025/ZClearance")
local ZClearance, rc = mc.mcRegGetValue(hreg)
hreg = mc.mcRegGetHandle(inst, "iRegs0/2025/MaterialOffset")
local MatOffset = mc.mcRegGetValue(hreg)
hreg = mc.mcRegGetHandle(inst, "iRegs0/2025/UseMatOffset")
...
local IMPERIAL_CONSTANTS = {
	TOUCH_PLATE_HEIGHT      = 0.125,        -- Z Touchplate is 1" (25.4mm) tall
	...
	Z_LIFT_HEIGHT           = 0.125 + 0.125,   -- How high to lift tool after script is complete (inches)	
	...
	Z_PROBE_DISTANCE        = 6         -- How long to probe the Z-Axis (inches)
}
...
local METRIC_CONSTANTS = {
	...
	Z_LIFT_HEIGHT           = 7,           -- How high to lift tool after script is complete (mm)	
	...
	Z_PROBE_DISTANCE        = 150         -- Distance to probe the Z-Axis (mm)
}
...
function cancelProbingProcedure()
	...
	--mc.mcMotionSetProbeComplete(INST) -- THIS IS A C FUNCTION ONLY AND NOT AVAILABLE IN LUA
...
function getConstants()
	...
	-- ADDED by CDE
	local hreg = mc.mcRegGetHandle(inst, "iRegs0/2010/PlateThickness")
	constants.TOUCH_PLATE_HEIGHTt = mc.mcRegGetValue(hreg)
	hreg = mc.mcRegGetHandle(inst, "iRegs0/2010/ZClearance")
	constants.Z_LIFT_HEIGHT = mc.mcRegGetValue(hreg)
	return constants
end
